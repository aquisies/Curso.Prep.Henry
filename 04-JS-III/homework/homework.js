...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  var res=1, dimension=arguments.length;
  
  if (dimension==0){ return 0;}
  
  if (dimension==1){ return arguments[0];}
...
function mesesDelAño(array) {
  ...
  var resultado=[], j=0, prueba;

  for(let i=0; i< array.length; i++){
    prueba = array[i];
    if (prueba == 'Enero' || prueba =='Marzo' || prueba =='Noviembre' ){
      resultado[j++]=prueba;
    }
  }
  if (j<3 ){
